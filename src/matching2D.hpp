...
double detKeypointsORB (std::vector<cv::KeyPoint> &keypoints, cv::Mat &img, cv::Mat& desc, bool bVis=false);
double detKeypointsAKAZE (std::vector<cv::KeyPoint> &keypoints, cv::Mat &img, cv::Mat& desc, bool bVis=false);
